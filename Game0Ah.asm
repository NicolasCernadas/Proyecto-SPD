...
;Cosas que arreglar:
				...
				; si tocas disparar muchas veces se bugea y no te deja mas
				; si disparas cuando hay una bala en movimiento y te moves, mueve la bala ya existente
		;LISTO--; que se fije los colores y cada enemigo sume diferente
				; que si te tocan los enemigos te maten y ponga la pantalla roja
				; que el juego no se cierre y que te deje poner jugar denuevo si no moriste y que sea mas rapido(menos retardos)
				; el enemigo secreto (aparece y se va, no determinantre para que gane el jugador)
				; hacer efectos de sonido
				; que las opciones de YOU WIN funcionen
...
jmp nadaBala
	...
	choqueBala:
	mov dh, 24   ;Pongo la bala en la fila 
